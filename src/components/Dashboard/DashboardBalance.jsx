...
function DashboardBalance() {
  ...
  return (
    <div className="relative mt-8 mb-3 mx-3 text-xs">
      ...
      <div className="relative flex h-[11rem] w-full flex-col justify-start rounded-[0.75rem] bg-purple-700 text-white py-3 shadow-sm">
        <div className="mx-3">
        ...
        <div className="mt-5 flex justify-between items-center bg-[#ffffff34] px-3 py-2">
          ...
          >
            <MdArrowOutward className="w-4 h-4 text-purple-700" />
            <span className="text-[1rem] text-purple-700"> withdraw</span>
          </Link>
        </div>
      </div>
    </div>
