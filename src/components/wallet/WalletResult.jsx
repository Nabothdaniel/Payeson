...
function WalletResult() {
  return (
    <div className='my-3 bg-white'>
          <div className="flex justify-between items-center gap-3 mb-5  shadow-sm rounded-md p-4  px-5 cursor-pointer">
      <div className="flex items-center gap-3">
        <div>
          <BsArrowUp className="w-10 h-10 text-orange-700 bg-orange-300/40 rounded-full p-2" />
        </div>
